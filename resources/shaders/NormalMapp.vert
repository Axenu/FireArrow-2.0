...
void main() {
	...
	vec3 T = (vec4(in_Tangent, 1.0)).xyz;
	vec3 B = (vec4(in_Bitangent, 1.0)).xyz;
	vec3 N = (vec4(in_Normal, 1.0)).xyz;

	mat3 TBNMatrix = mat3(T,B,N);
	pass_PointLightDirection = pointLightPosition - in_Position.xyz;
